...
customer_neighbor_fields <- as.data.table(customer_neighbors_clean)  # Convert correctly
...
1. Most customers align with our idea of a "White Truck"; this is possible but would frankly be a very powerful, albeit strong, statement. 

2. Most customers fall into a middle ground that isn't well understood; this would be pretty disappointing as it wouldn't empower Swire to view their business any differently
