...
In approach #4, Georgia will explore a fulfillment clustering model based on customer behavior. Additionally, she will experiment with forecasting approaches based on the two years worth of ordering volumes we have.
...
customer_neighbor_fields <- as.data.table(customer_neighbors_clean)
...
Each group member created individual models and worked together to combine said models into one cohesive modeling project.
