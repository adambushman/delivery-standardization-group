...
ggplot(
  swire_2025_est, 
  aes(
    x = (order_transactions_2023 + order_transactions_2024) / 2
    , y = avg_transaction_amt
    , color = segment
    , size = annual_total
  )
) +
  ...
  scale_color_manual(
    values = c(swire_colors$red, "gray")
  ) +
  scale_y_log10() +
  ...
  theme(
    ...
    panel.grid = element_line(color = swire_colors$gray, linewidth = 0.5)
  )
